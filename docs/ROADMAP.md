...
### Day 11
- [x] CloudWatch: log groups, metric alarms (error rate, SQS queue depth)
- [x] WAF: basic rules SQLi/XSS/rate limit
- [x] Secrets Manager: migrate DB creds + JWT secret ra khỏi .env
