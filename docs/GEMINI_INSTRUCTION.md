...
3. "docs/AGENT_LOG-week_2_3.md — log tuần 2 hiện tại (active). Tham khảo thêm docs/AGENT_LOG-week_2_2.md, docs/AGENT_LOG-week_2.md và docs/AGENT_LOG-week_1.md nếu cần tra cứu quyết định kỹ thuật."
...
Append vào docs/AGENT_LOG-week_2_3.md theo đúng format này — không thay đổi format:
